...
plt.plot(dependent_student_conv2_fc1, label="dependent_student_conv2_fc1(0.001)")

#dependent_student_conv2_fc1, add softmaxRMSE
...
plt.plot(dependent_student_conv2_fc1_softmax, label="dependent_student_conv2_fc1_add_softmaxRMSE(0.001)")

#dependent_student_conv2_fc1, add softmaxCrossentropy
dependent_student_conv2_fc1_softmaxCrossentropy = save_data_to_list(read_data(path+"conv2_fc1_softCrossentropy_newMethod"))
print("dependent_student_conv2_fc1_softmaxCrossentropy: " + str(caculate_convergence_time(dependent_student_conv2_fc1_softmaxCrossentropy)))
plt.plot(dependent_student_conv2_fc1_softmaxCrossentropy, label="dependent_student_conv2_fc1_add_softmaxCrossentropy(0.001)")
...
plt.plot(independent_student_conv2_fc1_new, label="independent_student_conv2_fc1(0.001)")
...
plt.plot(independent_student_conv2_fc1, label="independent_student_conv2_fc1(0.0001)")
