...
plt.plot(dependent_student_conv4_fc1, label="dependent_student_conv4_fc1(0.001)")
...
plt.plot(dependent_student_conv4_fc1_softmax, label="dependent_student_conv4_fc1_add_softmaxRMSE(0.001)")

#dependent_student_conv4_fc1, add crossEntropy, add new method
dependent_student_conv4_fc1_softCrossentropy = save_data_to_list(read_data(path+"conv4_fc1_softCrossentropy_newMethod"))
print("dependent_student_conv4_fc1_softCrossentropy: " + str(caculate_convergence_time(dependent_student_conv4_fc1_softCrossentropy)))
plt.plot(dependent_student_conv4_fc1_softCrossentropy, label="dependent_student_conv4_fc1_add_softCrossentropy(0.001)")

#dependent_student_conv4_fc1, add new method
...
#plt.plot(dependent_student_conv4_fc1_new, label="dependent_student_conv4_fc1(new method)(0.001)")
...
plt.plot(independent_student_conv4_fc1_new, label="independent_student_conv4_fc1(0.001)")
...
plt.plot(independent_student_conv4_fc1, label="independent_student_conv4_fc1(0.0001)")
