...
#print("new interval 10 (add initialization): " + str(caculate_convergence_time(new_interval_234_add_initialization)))
#plt.plot(new_interval_234_add_initialization, label="interval: 10 (add initialization, new)")
